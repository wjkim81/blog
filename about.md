...
- **AI System Architecture**: Research-to-Production workflows, API Design, MLOps fundamentals  
- **LLM Systems & RAG**: Prompt Engineering, Reasoning Pipelines, Interdisciplinary Concept Synthesis  
- **Backend / Enterprise Engineering**: Python, TypeScript/JavaScript, SQL, DB2 Systems  
...
- [A systematic review of deep learning-based denoising for low-dose computed tomography from a perceptual quality perspective (2024) – Biomedical Engineering Letters](https://link.springer.com/article/10.1007/s13534-024-00419-7)
- [Enhancing texture detail recovery in low-dose x-ray fluoroscopic images with a multi-frame deep learning framework (2023) – SPIE Medical Imaging](https://spie.org/medical-imaging/presentation/Enhancing-texture-detail-recovery-in-low-dose-x-ray-fluoroscopic/12925-136)
- [Deep Denoising Network for X-Ray Fluoroscopic Image Sequences of Moving Objects (2022) – MICCAI Workshop](https://link.springer.com/chapter/10.1007/978-3-031-17247-2_10)
- [An unsupervised two-step training framework for low-dose computed tomography denoising (2023) – Medical Physics](https://aapm.onlinelibrary.wiley.com/doi/10.1002/mp.16628)
- [No-reference perceptual CT image quality assessment based on a self-supervised learning framework (2022) – Machine Learning: Science and Technology](https://iopscience.iop.org/article/10.1088/2632-2153/aca87d/meta)
- [MM-Net: Multi-frame and Multi-mask-based Unsupervised Deep Denoising for Low-Dose CT (2022) – IEEE TRPMS](https://ieeexplore.ieee.org/document/9963593)
